        ...
        <v-form>
          <v-container>
            <v-row>
              <v-col cols="12" sm="12">
                <v-layout wrap>
                  <v-text-field v-model="newTodoName" solo placeholder="やりたいこと"></v-text-field>
...
export default {
  ...
  created(){
    ...
    this.todosRef.onSnapshot(querySnapshot => { //querySnapshot=現在の全てのデータ
      const obj = {}
      querySnapshot.forEach(doc => { //doc=firebaseのデータ内のドキュメント
